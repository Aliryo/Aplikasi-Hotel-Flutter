...
class DetailPage extends StatelessWidget {
  ...
  Widget viewReceipt(BuildContext context) {
    return Container(
  ...
  Widget bookingNow(HotelModel hotel, BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        border: Border(
  ...
  Widget activities(HotelModel hotel) {
    return SizedBox(
      height: 105,
  ...
  Widget name(HotelModel hotel, BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: Row(
        children: [
  ...
  Widget images(HotelModel hotel) {
    return SizedBox(
      height: 180,
      child: ListView.builder(
